...
def listarCarros(array,idNomeTable):
  ...
  for i in range(0,len(array)):
    ...
    contratante = "" if array[i].alugado is False else idNomeTable[array[i].dono]
          ...
          case 1:
            ...
            if idx <= 0 or idx > len(carros_cadastrados):
              ...
              if(confirm is True):
                ...
                carros_cadastrados[idx-1].dono = id_user
          ...
          case 2:
            ...
            if idx <= 0 or idx > len(carros_cadastrados):
              ...
              if(confirm is True):
                ...
                contratos[carros_cadastrados[idx-1].dono].remove(carros_cadastrados[idx-1])

                if contratos[carros_cadastrados[idx-1].dono] == []:
                  contratos.pop(carros_cadastrados[idx-1].dono)

                carros_cadastrados[idx-1].alugado = False
                carros_cadastrados[idx-1].dono = ""
    ...
    case 5:
      ...
      if(carro_encontrado != []):
        ...
        if(carro_encontrado[0].alugado):
          ...
          print("Contrante:",carro_encontrado[0].dono)
        else:
